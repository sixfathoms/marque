...
type RecordExecutionResponse struct {
	...
	// identical in all three fields. A retry that CONTRADICTS what is stored is
	// refused outright rather than acknowledged — one nonce is one attempt, and
	// two outcomes under it mean the caller reused it for a second.
