...
implementation_note: "Built: the schema, the annotation extension, the build failure for an unannotated method (internal/schema/annotations.go), and committed Go and Connect stubs. Not built: clients/ts/, the Pilot, Surveyor and relay schemas, typed errors, streams, and a client interceptor that honours keyed and unsafe. One method exists, GetVersion."
date: 2026-08-15
authors:
