...
- **2026-08-19**: Amended with a pointer: this record lists the fence among the controls break-glass leaves unchanged, and no signed artefact on this path carries one — the grant has no `fence` field and [EDR-0029](./0029-the-fast-path-authority-chain.md)'s break-glass verification compares none. True of the mechanism, hollow as a control. Open as [issue #26](https://github.com/sixfathoms/marque/issues/26); the decision is unchanged until it is settled.
